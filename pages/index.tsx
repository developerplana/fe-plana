                  ...
                  <div className="row row-cols-1 row-cols-lg-2">
                    <div className="col mb-4">
                      <div className="card card-project h-100 bg-transparent border-0">
                        <Image src="https://dropbox.com/scl/fi/epg8d52lnl9hgpbghen7t/Mask-group-2.jpg?rlkey=wgapmhh3fo4wftum9s8dyk21g&st=uym5rlvu&raw=1" width={1} height={1}layout="responsive" className="card-img-top mb-1 rounded-2" alt=""></Image>
                        <div className="card-body p-0">
                          <div className="row g-0">
                            ...
                            <div className="col-11">
                              <p className="card-title text-uppercase fw-bold">Card titles </p>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="col mb-4">
                      <div className="card card-project h-100 bg-transparent border-0">
                        <Image src="https://dropbox.com/scl/fi/dmk4na0no7trmivoklxwg/Mask-group.jpg?rlkey=2aarkte7jwifynm4guo1jt48d&st=3911uk9m&raw=1" width={1} height={1}layout="responsive" className="card-img-top mb-1 rounded-2" alt=""></Image>
                        <div className="card-body p-0">
                          <div className="row g-0">
                            <div className="col-1 pt-1">
